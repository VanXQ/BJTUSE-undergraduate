...
void MusicControl::MusicOn(){
    gameSound->play();
}

void MusicControl::MusicOff(){
    gameSound->stop();
}

void MusicControl::Music_eliminate(){
    gameSound_eliminate->play();
}

void MusicControl::Music_great(){
    gameSound_great->play();
}

void MusicControl::Music_excellent(){
    gameSound_excellent->play();
}

void MusicControl::Music_amazing(){
    gameSound_amazing->play();
}

void MusicControl::Music_unbelievable(){
    gameSound_unbelievable->play();
}

void MusicControl::Music_last_4sON(){
    gameSound_last_4s->play();
}

void MusicControl::Music_last_4sOFF(){
    gameSound_last_4s->stop();
}

void MusicControl::Music_down(){
    gameSound_down->play();
}

void MusicControl::Music_switch(QString musicPath){
